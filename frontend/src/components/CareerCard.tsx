...
/**
 * Defines the props for the CareerCard component.
 * It extends the base Recommendation type with additional props
 * for handling the UI selection state.
 */
...
// --- SVG ICONS ---
// These are stateless functional components for displaying icons.
  ...
  return (
    <div className={cardClasses} onClick={() => onSelect(title)}>
      ...
      <div className="border-t border-slate-700 pt-4 mt-auto">
        ...
        {/* Conditionally renders the detail sections only if data is available */}
        {estimatedSalary && (
